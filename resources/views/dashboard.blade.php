...
<div class="col-lg-7">
      <div class="card h-100 about">
          ...
          <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
            ...
            <p class="text-white">We are absolutely free to use. An open space for you to learn English online. Only your time and our app.</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="col-lg-5 px-4">
      <div class="h-100">
          <img src="assets/img/image01.png" style="width: 100px; height: 100px;">
        </div>
      </div>
    </div>
  </div>
...
<div class="col-lg-12 row px-4">
    <div class="col-lg-6 mb-lg-0 mb-4 mt-6">
    ...
    <div class="col-lg-6">
      <div class="h-100">
          <span class="border-radius-lg"></span>
          <div class="position-relative p-3">
          <img src="assets/img/image01.png" style="width: 380px; height: 380px; margin-left: 80px;" class="image-one">
          </div>
        </div>
      </div>
    </div>
          ...
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold text-secondary">Learning category</p>
                <h5 class="font-weight-bolder mb-0">
                <span style="font-size: 40px;">🎧</span> Listening
                </h5>
              </div>
            </div>
            <div class="col-4 text-end">
          ...
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold text-secondary">Learning category</p>
                <h5 class="font-weight-bolder mb-0">
                <span style="font-size: 40px;">📖</span> Reading
                </h5>
              </div>
            </div>
            <div class="col-4 text-end">
          ...
          <div class="row">
            <div class="col-8">
              <div class="numbers">
                <p class="text-sm mb-0 text-capitalize font-weight-bold text-secondary">Learning category</p>
                <h5 class="font-weight-bolder mb-0">
                <span style="font-size: 40px;">🖋️</span> Writing
                </h5>
              </div>
            </div>
            <div class="col-4 text-end">
  ...
  <div class="col-lg-12 row px-4">
      ...
      <div class="card">
        <div class="card-body p-3">
          <div class="row">
            <div class="col-lg-6">
              <div class="d-flex flex-column h-100">
                <p class="mb-1 pt-2 text-bold">Beginning</p>
                <h5 class="font-weight-bolder">Don't know how to start?</h5>
                <p>Complete this English level test, so you'll know from what to start.</p>
                <a class="btn bg-gradient-dark mb-3 text-white text-body text-sm font-weight-bold mb-0 icon-move-right mt-auto" href="https://www.englishtag.com/tests/level_test.asp">
                 <span class="text-white">Test your English level</span>
    ...
    <div class="col-lg-5">
      <div class="card h-100">
          <span class="mask motivation-card  border-radius-lg"></span>
          <div class="card-body position-relative z-index-1 d-flex flex-column h-100 p-3">
            <h5 class="text-white font-weight-bolder mb-4 pt-2">Daily motivation :)</h5>
            <p class="text-white">"Learning a new language is like becoming a whole new person." - Haruki Murakami</p>
            <p class="text-white">"Learning another language is not only learning different words for the same things but learning another way to think about things." - Flora Lewis</p>
          </div>
        </div>
      </div>
    </div>
