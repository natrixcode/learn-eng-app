...
<div>
    <div class="container-fluid">
        <div class="page-header border-radius-xl mt-6">
                <!-- <p class="paragraph mt-5 mx-4 font-weight-bolder ">Here you can add some details about yourself</p> -->
        </div>
        <div class="card card-body blur shadow-blur mx-4 mt-n6">
            <div class="row gx-4">
                <div class="col-auto">
                    <div class="avatar avatar-xl position-relative">
                        <img src="../assets/img/team.jpg" alt="..." class="w-100 border-radius-lg shadow-sm">
