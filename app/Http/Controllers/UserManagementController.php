...
class UserManagementController extends Controller
{
    ...
    {
        $users = User::all();
        return view('laravel-examples/user-management', ['users' => $users, 'msg' => '']);
    }
    ...
    public function store(Request $request)
    {
        ...
        $post->save();
        return view('laravel-examples/user-management', ['users' => $users, 'msg' => "Everything is ok"]);
    }
    ...
    public function destroy($id)
    {
        $user = User::find($id);
            ...
            $user->delete();
        return redirect(route('user-management', ['user' => $user, 'id' => $id]));
    }
}
